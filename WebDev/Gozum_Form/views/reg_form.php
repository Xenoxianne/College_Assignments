                ...
                <div class="form-step">
                    ...
                    <div style = "display: flex;">
                        ...
                        <div class="input-group">
                            ...
                            <div class = "radio-adjust"><input type="radio" name = "prefContact" value = "phone"> <label class = "radio-lbl">Phone</label><br></div>
                            <div class = "radio-adjust"><input type="radio" name = "prefContact" value = "email"> <label class = "radio-lbl">Email</label><br></div>
                            <div class = "radio-adjust"><input type="radio" name = "prefContact" value = "any"> <label class = "radio-lbl">Any</label></div>
                        </div>
                    </div>
