            ...
            <div class="right-box">
                ...
                <div class="form-step">
                    ...
                    <div class="input-group" style = "margin-top: 40px;">
                        ...
                        <div class = "req-checkbox"><input type="checkbox" name="memRules" required> I have read, understood, and accepted the rules for membership.</div>
                    </div>
                    ...
                    <div class="input-group" style = "margin-top: 40px;">
                        ...
                        <div class = "req-checkbox"><input type="checkbox" name="memPrivacy" required> I have read, understood, and accepted the PRIVACY POLICY for membership.</div>
                    </div>
